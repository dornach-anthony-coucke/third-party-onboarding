...
2. Add a `package.json` with the naming convention `@third-party-onboarding-manager/<package-name>`
...
```bash
cd packages/<package-name>
pnpm add @third-party-onboarding-manager/<other-package>@workspace:*
```
